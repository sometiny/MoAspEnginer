...
function $safecode(sessionKey,opt){
	...
	var fontdata = IO.file.readAllText(__dirname + "\\fonts\\" + cfg.font + ".font");
	...
	F.echo(base64.toBinary(base64.e(header.toByteArray())),F.TEXT.BIN);
	F.echo(base64.toBinary(base64.e(body.toByteArray())),F.TEXT.BIN);
}
//=====================================================================
// GIF Support etc.
//
