...
ModifyController.extend("modify",function(){
	...
	if(NameOld==""){
		...
		if(L.eof()){
			...
			F.require("sha1");
			if(F.exports.sha1.SHA1(F.md5(F.exports.sha1.SHA2(F.post("AuthOld"))))!=R.Auth){
				...
				if(F.post("Auth")!=""){
					if(F.post("Auth")!=F.post("AuthRe")){
						...
						Model__("Authorize","Id").where("Name='" + NameOld + "'").update("Name",Name,"Auth",F.exports.sha1.SHA1(F.md5(F.exports.sha1.SHA2(F.post("Auth")))));
