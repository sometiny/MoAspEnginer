...
NoticeController.extend("Index",function(){
	F.require("wx/WXMessage");
	var WX = new F.exports.WXMessage(), WxDelegate = Mo.A("Delegate");
	WX.SignManager.token=Mo.C("WX.token");
	...
	try{
		var received = F.string.fromBinary(Request.BinaryRead(Mo.C("WX.maxrequestlength")),"utf-8");
