...
TXAPI.prototype.Translate = function(locations,coord_type){
	...
	var http = F.exports.net.http.request.create(uri);
...
TXAPI.prototype.Geoencoder = function(location,get_poi){
	...
	return F.exports.net.http.request.create(uri).getjson("utf-8") || {"status":-1,"message":"data error"};
};
