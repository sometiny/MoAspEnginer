function WXMessage(){
	...
	this.Padding = {
		pad: function(F, D) {
			...
			var G = FUN.exports.CryptoJS.lib.WordArray.create(C, H);
			F.concat(G)
		},
		unpad: function(A) {
...
WXMessage.prototype.encrypt = function(){
	...
	if(!F.exports.CryptoJS)F.vendor("CryptoJS")
	var Encoding = F.exports.encoding;
	var CryptoJS = F.exports.CryptoJS;
	var key_byte = F.base64.d(Mo.C("WX.aeskey")+"=");
	...
	F.sortable.sort(true);
	var signature = F.exports.SHA1(F.sortable.join());
...
WXMessage.prototype.decrypt = function(msg_encrypt,msg_signature){
	...
	F.sortable.add(msg_encrypt);
	F.sortable.sort(true);
	if(F.exports.SHA1(F.sortable.join())!=msg_signature){
...
WXMessage.prototype.loadRequest = function(requeststr){
	...
	F.require("xml");
	var xml = F.exports.xml.Load(requeststr)
	...
	if(F.get("encrypt_type")=="aes" && !this.IgnoreCrypt){
		...
		xml = F.exports.xml.Load(this.Message);
		if(xml.ROOT==null){
...
return exports.WXMessage = WXMessage;