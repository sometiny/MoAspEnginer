...
WXServices.prototype.getgroups = function(){
	return this.parseerror(F.exports.net.http.request.create("https://api.weixin.qq.com/cgi-bin/groups/get?access_token=" + this.Auth.access_token).getjson("utf-8"));
};
WXServices.prototype.getusergroup = function(openid){
	return this.parseerror(F.exports.net.http.request.create(
...
WXServices.prototype.getmenu = function(){
	return F.exports.net.http.request.create("https://api.weixin.qq.com/cgi-bin/menu/get?access_token=" + this.Auth.access_token).gettext("utf-8");
}
WXServices.prototype.createmenu = function(menu){
	return this.parseerror(F.exports.net.http.request.create("https://api.weixin.qq.com/cgi-bin/menu/create?access_token=" + this.Auth.access_token,"POST",menu).getjson("utf-8"));
}
WXServices.prototype.deletemenu = function(){
	return this.parseerror(F.exports.net.http.request.create("https://api.weixin.qq.com/cgi-bin/menu/delete?access_token=" + this.Auth.access_token).getjson("utf-8"));
}
WXServices.prototype.downloadmedia = function(mediaid){
	var http = F.exports.net.http.request.create("http://file.api.weixin.qq.com/cgi-bin/media/get?access_token=" + this.Auth.access_token + "&media_id=" + mediaid).send();
...
WXServices.prototype.upload = function(type,path,contenttype){
	...
	var httpupload = F.exports.net.http.upload("http://file.api.weixin.qq.com/cgi-bin/media/upload?access_token=" + this.Auth.access_token + "&type=" + type);
...
WXServices.prototype.getUser = function(openid,lang){
	return this.parseerror(F.exports.net.http.request.create("https://api.weixin.qq.com/cgi-bin/user/info?access_token=" + this.Auth.access_token + "&openid="+(openid||"")+"&lang=" + (lang||"zh_CN")).getjson("utf-8"));
}

WXServices.prototype.getUsers = function(next){
	this.errmsg="";
	var json = F.exports.net.http.request.create("https://api.weixin.qq.com/cgi-bin/user/get?access_token=" + this.Auth.access_token + "&next_openid="+(next||"")).getjson("utf-8");
	if(json!=null){
		if(json["errcode"]){
			this.errmsg = json["errmsg"];
		}else{
...
WXServices.prototype.getAccessToken = function(){
	...
	var json = F.exports.net.http.request.create("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=" + this.Auth.appID + "&secret=" + this.Auth.appsecret + "").getjson("utf-8");
	if(json!=null){
		if(json["errcode"]){
			this.errmsg = json["errmsg"];
		}else{
...
return exports.WXServices = WXServices;