...
WXServicesMuti.prototype = new  F.exports.WXServices();
...
WXServicesMuti.prototype.sendmessage = function(json){
	return this.parseerror(F.exports.net.http.request.create("https://api.weixin.qq.com/cgi-bin/message/mass/sendall?access_token=" + this.Auth.access_token,"POST",json).getjson("utf-8"));
};
...
return exports.WXServicesMuti = WXServicesMuti;