...
Class MoLibUpload
	...
	Private Sub Class_Initialize()
		Dim T__
		Set Form = F.activex("Scripting.Dictionary")
		Set Fils = F.activex("Scripting.Dictionary")
	...
	Public Function Search(ByVal formname)
		...
		Dim FileCollection
		Set FileCollection = F.activex("Scripting.Dictionary")
		Dim v
		For Each v In Fils
	...
	Public Function Save(Byref Name,byval tOption, byval OverWrite)
		...
		If Not IsP Then Path = F.mappath(mvarSavePath)
		Path = Replace(Path, "/", "\")
